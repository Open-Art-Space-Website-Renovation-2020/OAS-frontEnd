...
export default {
	...
	async asyncData({ $axios }) {
		const jigsaws = await $axios.$get("/fapi/jigsaw/")
	...
	head: {
		title: "Jigsaw Games | Open Art Space",
	},
}
</script>
		...
		>
			...
			>
				<div class="ml-4 md:(mr-4 rtl:mr-0 ml-0) relative">
					...
					<h1
						class="absolute left-0 ml-2 mt-11 top-0 rtl:(right-0 mr-8 mt-6 text-2xl) text-5xl"
					>
						{{ $t("jigsaw") }}
					</h1>
				</div>
